...
export function ThemeProvider({
  ...
  useEffect(() => {
    ...
    const savedTheme = (localStorage.getItem("ui-theme") as Theme) || "dark";
    setTheme(savedTheme);

    // Apply dark theme immediately to prevent flickering
    root.classList.add("dark");

    // Then check stored preference and system preference
  ...
  // This effect watches for theme changes after initial load
  useEffect(() => {
    const root = window.document.documentElement;
